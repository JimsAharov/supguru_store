  ...
  return (
    <Row  xs={1} md={2}>
      ...
      <Col className="display-flex-right">
        ...
        <Container>
          <p>Если Вы хотите просто покататься или протестировать интересующую Вас модель доски, то приглашаем к нам на прокат, который находится на Чёрной Речке. Предварительная запись обязательна!
Плюшки от Sup Guru:<ul>
