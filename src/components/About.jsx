    ...
    <Row style={styles.container_about} xs={1} md={2}>
      ...
      <Col className="display-flex-left">
        ...
        <div className="about_left">
          ...
          <p>
            ...
            дилерской гарантией по самым доступным ценам. <br /> <br /> Предоставляем <b>бесплатный тест-драйв</b> (10 мин.) перед покупкой, чтобы Вы на 100%
      ...
      <Col id="rent_card" className="display-flex-right">
        ...
        <div className="about_left">
          ...
          <Button href="#map">Как проехать</Button>
        </div>
      </Col>
    </Row>
  );
